  ...
  return Form(
    ...
    child: Column(
      ...
      children: [
        ...
        TextFormFieldWidget(
            hintText: "enter your email", controller: AuthCubit.get(context).ctrlEmail,validator:(value) {
        ...
        TextFormFieldWidget(
            hintText: "enter your password", controller: AuthCubit.get(context).ctrlPassword,validator:  (value) {
          if (value == null || value.isEmpty) {
